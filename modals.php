    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <a href="villas.php" class="item-menu text-center">Виллы</a>
                <a href="apartments.php" class="item-menu text-center">Апартаменты</a>
                <a href="feedback.php" class="item-menu text-center">Отзывы</a>
                <a href="contacts.php" class="item-menu text-center">Контакты</a>
            </div>
        </div>
    </div>
</div>
