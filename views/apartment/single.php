...
<?php $apartmentName = str_replace('_', ' ', $apartment['name']); ?>

<h1 id="in-title" class="text-center visible-md-block visible-lg-block"><?php echo $apartmentName; ?></h1><br>
<h1 class="text-center h1-mob-single visible-xs-block visible-sm-block"><?php echo $apartmentName; ?></h1>
		...
		<div class="lightgallery-wrap">
			<div id="lightgallery">
				<?php foreach ($imgNameList as $img): ?>
			    	<a href="/upload/images/<?php echo $apartment['name']; ?>/<?php echo $img; ?>">        	    <img class="img-responsive" src="/upload/images/<?php echo $apartment['name']; ?>/<?php echo $img; ?>" alt="">
			    	</a>    	
				<?php endforeach; ?>
			</div>
			<div class="big-img-realty visible-md-block visible-lg-block">    
				<img class="img-responsive" src="/upload/images/<?php echo $apartment['name']; ?>/<?php echo $imgNameList[0]; ?>" alt="">
			</div>
		</div>
	</div>
</div>
    ...
    <div class="row"> 	
		<div class="params-val-wrap">
			<div id="param-of-realty">
				...
				<div class="param-even"><strong>Вместимость</strong></div>
			...
			<div id="val-of-realty" class="big-img-realty visible-md-block visible-lg-block">  
				<div><?php echo $apartment['area']; ?> м2</div>
				<div class="param-even"><?php echo $apartment['view']; ?></div>
				<div><?php echo $apartment['bedrooms']; ?></div>
				<div class="param-even"><?php echo $apartment['capacity']; ?> человек</div>
				<div><?php echo $apartment['dist_sea']; ?> м</div>
				<div class="param-even"><?php echo $apartment['dist_tivat']; ?> км</div>
				<div><?php echo $apartment['dist_podg']; ?> км</div>
			...
			<div id="description"><?php echo $apartment['description']; ?></div>
			...
			<table class="table table-bordered table-prices">
				...
				<tr>
					<td><?php echo $apartment['price_may']; ?> €</td>
					<td><?php echo $apartment['price_jun']; ?> €</td>
					<td><?php echo $apartment['price_jul']; ?> €</td>
					<td><?php echo $apartment['price_aug']; ?> €</td>
					<td><?php echo $apartment['price_sep']; ?> €</td>
		...
		<?php for ($i = 0; $i < count($imgNameList); $i++): ?>
			<?php if ($i == 0): ?>
				<div class="item active">
					<img class="img-responsive" src="/upload/images/<?php echo $apartment['name']; ?>/<?php echo $imgNameList[$i]; ?>" alt="">
			<?php else: ?>
				<div class="item">
					<img class="img-responsive" src="/upload/images/<?php echo $apartment['name']; ?>/<?php echo $imgNameList[$i]; ?>" alt="">
			<?php endif; ?>	
    ...
    <div class="row"> 	
		<div class="col-xs-12">
			...
			<table class="table-param-mob">
				<tr>
					<th>Площадь</th>
					<td><?php echo $apartment['area']; ?> м2</td>
				</tr>
				<tr class="param-even">
					<th>Вид</th>
					<td><?php echo $apartment['view']; ?></td>
				</tr>
				<tr>
					<th>Спальни</th>
				...
				<tr class="param-even">
					<th>Вместимость</th>
					<td><?php echo $apartment['capacity']; ?> человек</td>
				</tr>
				<tr>
					<th>До моря</th>
					<td><?php echo $apartment['dist_sea']; ?> м</td>
				</tr>
				<tr class="param-even">
					<th>До а/п Тиват</th>
					<td><?php echo $apartment['dist_tivat']; ?> км</td>
				</tr>
				<tr>
					<th>До а/п Подгорица</th>
					<td><?php echo $apartment['dist_podg']; ?> км</td>
				</tr>
				<tr class="param-even">
					<th>Трансфер</th>
					<td>платный</td>
